...
public class GameUIManager : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		LoadingStateManager.LoadMainMenuEvent.AddListener(() => EnableScreen(mainMenuScreen));
		LoadingStateManager.LoadingEvent.AddListener(() => EnableScreen(loadingScreen));
	}

	private void OnDisable()
	{
		LoadingStateManager.LoadMainMenuEvent.RemoveListener(() => EnableScreen(mainMenuScreen));
	...
	{
		AudioManager.PlaySound(GameSound.GUI_ForwardNavigation);
	...
	public class BaseUIScreen
	{
		...
		public virtual bool IsEnabled() => screen.activeInHierarchy == true;

		public virtual void Display(bool p_ShouldDisplayScreen) => screen.SetActive(p_ShouldDisplayScreen);
	...
	public class MainMenuScreen : BaseUIScreen
	{
		...
		{
			UI.SetupButtonMethods(startButton, 
				() => GameManager.OnGameStartEvent?.Invoke(), UI.MainMenu_StartButton);
			UI.SetupButtonMethods(creditsButton, 
				() => GameUIManager.s_Instance.DisplayCredits(true), UI.MainMenu_CreditsButton);
			UI.SetupButtonMethods(leaveButton,
				() => GameManager.OnApplicationQuit?.Invoke(), UI.MainMenu_LeaveButton);
		}
	...
	public class CreditsMenuScreen : BaseUIScreen
	{
		...
		public override void Setup()
		{
			...
			developerHeading.text = UI.CreditsMenu_DeveloperHeading;
			developer.text = "Lead Programmer: Bradley Seymour";
		}
...
public class UI
{
	...
	#region Main Menu 
	public static string MainMenu_StartButton = "Start";
	public static string MainMenu_CreditsButton = "Credits";
	public static string MainMenu_LeaveButton = "Leave";
	#endregion

	#region Credits Menu 
	
	public static string CreditsMenu_Title = "Credits";
	public static string CreditsMenu_DeveloperHeading = "Developers";
	public static string CreditsMenu_CloseButton = "Back";
